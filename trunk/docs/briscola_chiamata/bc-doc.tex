...
- important: what's is missing in the prototype? well actual agents do only dumb reasoning about team settings and cheating
 personalized agents that implements different strategies each one with its reasoning would be great, also implement reinforce learning would be nice,
