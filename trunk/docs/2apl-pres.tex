...
\item First version released in 2008. It is the successor of 3APL, and added multi-agent capabilities. It is built on top of JADE platform.
...
\end{itemize}  
 ...
 \begin{itemize}
\item 2APL distinguishes itself from other agent-oriented programming languages by realizing an effective integration of declarative and imperative style programming.

\item The \emph{declarative style programming} supports the implementation of the mental state of agents allowing them to reason about their mental states and update them accordingly.

\item The \emph{imperative style programming} supports the implementation of processes allowing programming constructs to implement both the flow of control as well as mechanisms such as procedure call, recursion, plan revision, and interface to existing imperative programming languages.
...
\begin{itemize}
    \item Programming Constructs:
     ...
     \begin{itemize}
        ...
        \item Encapsulation: Including 2APL in other 2APL 
...
\frame[allowframebreaks]{
  \frametitle{Few words about Prolog}
...
\frame{
    \frametitle{Few words about the blockworld environment}

	\begin{columns}
  		\begin{column}{0.5\textwidth}
			\begin{itemize}
    			\item The blockworld environment models a $<n, n>$ grid world.
    			\item Each agent can move in each of four directions (north, south, east and west).
    			\item Each agent can pickup or drop one bomb at a time.
			\end{itemize}    
		\end{column}
		\begin{column}{0.5\textwidth}
			\includegraphics[keepaspectratio,scale=0.35]{fig/block.png}
		\end{column}
	\end{columns}
}
...
\begin{frame}[fragile,allowframebreaks]
	...
	When the execution of a plan fails? If the execution of its first action fail.
...
\frame{
  ...
  % the objective of the formal semantics is to validate the program across the specifications
...
\frame{
  ...
  Abstract actions are based on application of procedural call rules, of the form:
...
\frame{
  ...
  \begin{itemize}
    ...
    \item The fact that 2APL is develop over JADE allows to use all the functionality that this framework has to communicate to other agents.
...
\frame{
    \frametitle{RMA: Screenshot}
      \begin{center}
  \includegraphics[keepaspectratio,scale=0.6]{fig/rma.png}
  \end{center}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
    \frametitle{Sniffer: Screenshot}
      \begin{center}
  \includegraphics[keepaspectratio,scale=0.6]{fig/sniffer.png}
  \end{center}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
    \frametitle{Introspector: Screenshot}
      \begin{center}
  \includegraphics[keepaspectratio,scale=0.6]{fig/introspector.png}
  \end{center}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
...
\begin{itemize}
    ...
    \begin{itemize}
		\item Used to visualize and program the deliberation cycle of an agent. 
	\end{itemize}
    \item  The state tracer
    \begin{itemize}
		\item Used for showing the execution trace of an agent. 
		\item Each state shows the beliefs, plans, goals, and log of the agent as a result of executing one deliberation step.
	\end{itemize}
\end{itemize}    
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Demo and examples}			%% BORJA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
    \item Bos Wars  is an open source, cross-platform real-time strategy game. The project was started by Tina Petersen in 2004, and the current project leader is François Beerten. The game is written in C++ and Lua with the SDL library.
    \item  Can be used as an environment for agent testing, 2APL examples available online.
    \item  There is a great video of a 2APL agent using reinforcement learning to find the optimal strategy for victory.
    \item  \url{http://www.youtube.com/watch?v=mt3Mk5Ea484}
\end{itemize}    
...
\begin{itemize}
    ...
    \item Already being used in several projects and thesis.
\end{itemize}    
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Multi-agent level
	\begin{itemize}
	  \item allow the implementation of social and organizational issues such as norms, obligations, prohibition, permissions, power relation, delegations of tasks, responsibility, and trust
	\end{itemize}
    
        \item Individual agent level
	\begin{itemize}
	  \item implementation of various goals types such as perform, achieve and maintenance goals
	  \item enable the specification of conflicting goals
	  \item implementation of various commitment strategies such as blindly-minded, single-minded, and open-minded through intentions
	\end{itemize}
