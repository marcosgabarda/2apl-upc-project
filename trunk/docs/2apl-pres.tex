...
\newcommand{\bformsem}{\begin{beamerboxesrounded}[upper=semupcol,lower=semlowco* Reasoning cycle (Deliberation, Means-end Reasoning... 
...
reasioning cycle). l,shadow=true]{Formal Semantics}}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item The agent can perform a sense action to determine the effect of an action
	\end{itemize}	
