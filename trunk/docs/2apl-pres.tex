...
\frame[allowframebreaks]{
	...
	\begin{enumerate}
		...
		\item If the first action of a fails and there is no plan repair rule to repair it, then the failed plan may be successfully executed in the next deliberation cycle
	\end{enumerate}
