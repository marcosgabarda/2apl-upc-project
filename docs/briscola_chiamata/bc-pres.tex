...
\frame{
  ...
  \begin{itemize}
    \item System Specification: actors, actions, percepts, goals and scenarios
    \vskip 2.0ex
...
\frame{
  ...
  \begin{itemize}
    % For Marcos: The prototype is a first instantiation of the design using 2APL platform
    \item The prototype is an approach of our Prometheus design of Briscola Chiamata applied to 2APL.
    % For Marcos: The purpose is to evaluate the 2APL platform with a real problem, not developing a full working card game
    \item We want to test the develop of a real problem using 2APL platform.
