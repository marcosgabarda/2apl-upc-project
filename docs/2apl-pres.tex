...
\frame{
	...
	There are 2 distinguished set of programming constructs that allows to define:
...
\begin{frame}[allowframebreaks,fragile]
	...
	A multi-agent system is defined as a set of couples:
...
\frame[allowframebreaks]{
	...
	\begin{verbatim}
	<baction> = ( ``skip'' 
	            | <beliefupdate> | <sendaction>| <externalaction> 
