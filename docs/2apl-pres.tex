...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item The agent can perform a sense action to determine the effect of the previous action
	\end{itemize}	
...
\begin{frame}[fragile,allowframebreaks]
	...
	\begin{enumerate}
		...
		\item handling
		\begin{itemize}
			\item the reception of messages received from other agents
	...
	A PC rule is applied only iif the belief condition is entailed by the belief base.
